    ...
    : Form
{
    ...
    public Form1()
    {
        ...
        var ellipse1 = new Ellipse<double>(ellipse) { Pen = Pens.Green, Name = "Ellipse" };
        var conicSection = new Ellipse<double>(ellipse).ToUnitConicSection();
        conicSection.Pen = Pens.Red;
        conicSection.Name = "Conic Ellipse";
        var conicSection1 = Conversion.RescaleConicSection(new Ellipse<double>(ellipse).ToUnitConicSection());
        conicSection1.Pen = Pens.DarkBlue;
        conicSection1.Name = "Scaled Conic Ellipse";
        var vertexParabola1 = new VertexParabola<double>(vertexParabola) { Pen = Pens.Blue, Name = "Vertex Parabola" };
        //var standardParabola = new StandardParabola(Conversion.VertexParabolaToStandardParabola(vertexParabola)) { Pen = Pens.Red };
        var conicSection2 = new VertexParabola<double>(vertexParabola).ToUnitConicSection();
        ...
        var conicSection3 = new Line<double>(100d, 100d, 200d, 200d).ToUnitConicSection();
