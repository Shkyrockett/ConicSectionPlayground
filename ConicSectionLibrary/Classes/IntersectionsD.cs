...
namespace ConicSectionLibrary
{
    ...
    /// 
    /// </summary>
    public static class IntersectionsD
    {
        /// <summary>
        ...
        public static List<PointF> LineRectangleIntersection(
            ...
            double epsilon = double.Epsilon) => LinePointRectangleIntersection(x1, y1, i1, j1, x2, y2, width + x2, height + y2, epsilon);
            ...
            double x1, double y1, double x2, double y2)
        {
            ...
            var b = (A * 2d * x1 * dx) + (B * x1 * dy) + (B * y1 * dx) + (C * 2d * y1 * dy) + (D * dx) + (E * dy);
            ...
            {
                var t = -b / (2d * a);
                solutions.Add(new PointF((float)(x1 + (t * dx)), (float)(y1 + (t * dy))));
            }
            else if (determinant > 0d)
            {
                var root = Sqrt((b * b) - (4d * a * c));
                var t1 = (-b + root) / (2d * a);
                solutions.Add(new PointF((float)(x1 + (t1 * dx)), (float)(y1 + (t1 * dy))));
                var t2 = (-b - root) / (2d * a);
                solutions.Add(new PointF((float)(x1 + (t2 * dx)), (float)(y1 + (t2 * dy))));
            }
